...
func TestRunner_RunSequential(t *testing.T) {
	t.Run("all pass", func(t *testing.T) {
		...
		result := requireResultValue[*RunAllResult](t, runner.RunSequential(context.Background(), []RunSpec{
...
func TestRunner_RunParallel(t *testing.T) {
	t.Run("all run concurrently", func(t *testing.T) {
		...
		result := requireResultValue[*RunAllResult](t, runner.RunParallel(context.Background(), []RunSpec{
			{Name: "first", Command: "echo", Args: []string{"1"}},
			{Name: "second", Command: "echo", Args: []string{"2"}},
			{Name: "third", Command: "echo", Args: []string{"3"}},
		}))
...
func TestRunner_RunAll(t *testing.T) {
	t.Run("respects dependencies", func(t *testing.T) {
		...
		result := requireResultValue[*RunAllResult](t, runner.RunAll(context.Background(), []RunSpec{
	...
	t.Run("preserves input order", func(t *testing.T) {
		...
		result := requireResultValue[*RunAllResult](t, runner.RunAll(context.Background(), specs))
...
func TestRunner_ContextCancellation(t *testing.T) {
	t.Run("run sequential skips pending specs", func(t *testing.T) {
		...
		result := requireResultValue[*RunAllResult](t, runner.RunSequential(ctx, []RunSpec{
			{Name: "first", Command: "echo", Args: []string{"1"}},
			{Name: "second", Command: "echo", Args: []string{"2"}},
		}))
	...
	t.Run("run all skips pending specs", func(t *testing.T) {
		...
		result := requireResultValue[*RunAllResult](t, runner.RunAll(ctx, []RunSpec{
			{Name: "first", Command: "echo", Args: []string{"1"}},
			{Name: "second", Command: "echo", Args: []string{"2"}, After: []string{"first"}},
		}))
...
func TestRunner_NilService(t *testing.T) {
	...
	_, err := resultValue[*RunAllResult](runner.RunAll(context.Background(), nil))
	requireError(t, err)
	assertErrorIs(t, err, ErrRunnerNoService)

	_, err = resultValue[*RunAllResult](runner.RunSequential(context.Background(), nil))
	requireError(t, err)
	assertErrorIs(t, err, ErrRunnerNoService)

	_, err = resultValue[*RunAllResult](runner.RunParallel(context.Background(), nil))
	requireError(t, err)
	assertErrorIs(t, err, ErrRunnerNoService)
}
...
func TestRunner_NilContext(t *testing.T) {
	...
	_, err := resultValue[*RunAllResult](runner.RunAll(nil, nil))
	requireError(t, err)
	assertErrorIs(t, err, ErrRunnerContextRequired)

	_, err = resultValue[*RunAllResult](runner.RunSequential(nil, nil))
	requireError(t, err)
	assertErrorIs(t, err, ErrRunnerContextRequired)

	_, err = resultValue[*RunAllResult](runner.RunParallel(nil, nil))
	requireError(t, err)
	assertErrorIs(t, err, ErrRunnerContextRequired)
}
...
func TestRunner_InvalidSpecNames(t *testing.T) {
	...
	t.Run("rejects empty names", func(t *testing.T) {
		_, err := resultValue[*RunAllResult](runner.RunSequential(context.Background(), []RunSpec{
	...
	t.Run("rejects empty dependency names", func(t *testing.T) {
		_, err := resultValue[*RunAllResult](runner.RunAll(context.Background(), []RunSpec{
	...
	t.Run("rejects duplicate names in parallel mode", func(t *testing.T) {
		_, err := resultValue[*RunAllResult](runner.RunParallel(context.Background(), []RunSpec{
...
func TestRunner_NewRunner_Bad(t *testing.T) {
	runner := NewRunner(nil)
	result, err := resultValue[*RunAllResult](runner.RunSequential(context.Background(), nil))
	assertNil(t, result)
	assertErrorIs(t, err, ErrRunnerNoService)
}
...
func TestRunner_Runner_RunAll_Good(t *testing.T) {
	svc, _ := newTestService(t)
	runner := NewRunner(svc)
	result := requireResultValue[*RunAllResult](t, runner.RunAll(context.Background(), []RunSpec{{Name: "echo", Command: "echo", Args: []string{"ok"}}}))
	requireLen(t, result.Results, 1)
	assertTrue(t, result.Success())
}
...
func TestRunner_Runner_RunAll_Bad(t *testing.T) {
	runner := NewRunner(nil)
	result, err := resultValue[*RunAllResult](runner.RunAll(context.Background(), nil))
	assertNil(t, result)
	assertErrorIs(t, err, ErrRunnerNoService)
}
...
func TestRunner_Runner_RunAll_Ugly(t *testing.T) {
	svc, _ := newTestService(t)
	runner := NewRunner(svc)
	result, err := resultValue[*RunAllResult](runner.RunAll(context.Background(), []RunSpec{{Name: "self", Command: "echo", After: []string{"self"}}}))
	assertNil(t, result)
	assertErrorIs(t, err, ErrRunnerInvalidDependencyName)
}
...
func TestRunner_Runner_RunSequential_Good(t *testing.T) {
	svc, _ := newTestService(t)
	runner := NewRunner(svc)
	result := requireResultValue[*RunAllResult](t, runner.RunSequential(context.Background(), []RunSpec{{Name: "echo", Command: "echo", Args: []string{"ok"}}}))
	requireLen(t, result.Results, 1)
	assertTrue(t, result.Success())
}
...
func TestRunner_Runner_RunSequential_Ugly(t *testing.T) {
	svc, _ := newTestService(t)
	runner := NewRunner(svc)
	result, err := resultValue[*RunAllResult](runner.RunSequential(nil, []RunSpec{{Name: "echo", Command: "echo"}}))
	assertNil(t, result)
	assertErrorIs(t, err, ErrRunnerContextRequired)
}
...
func TestRunner_Runner_RunParallel_Good(t *testing.T) {
	svc, _ := newTestService(t)
	runner := NewRunner(svc)
	result := requireResultValue[*RunAllResult](t, runner.RunParallel(context.Background(), []RunSpec{{Name: "echo", Command: "echo", Args: []string{"ok"}}}))
	requireLen(t, result.Results, 1)
	assertTrue(t, result.Success())
}
...
func TestRunner_Runner_RunParallel_Bad(t *testing.T) {
	runner := NewRunner(nil)
	result, err := resultValue[*RunAllResult](runner.RunParallel(context.Background(), nil))
	assertNil(t, result)
	assertErrorIs(t, err, ErrRunnerNoService)
}
...
func TestRunner_Runner_RunParallel_Ugly(t *testing.T) {
	svc, _ := newTestService(t)
	runner := NewRunner(svc)
	result, err := resultValue[*RunAllResult](runner.RunParallel(context.Background(), []RunSpec{{Name: "", Command: "echo"}}))
	assertNil(t, result)
	assertErrorIs(t, err, ErrRunnerInvalidSpecName)
}
